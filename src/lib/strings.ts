...
export const nl = {
  ...
  zone: {
    ...
    vorm: 'Vorm',
    label: 'Label',
    labelVraag: 'Hoe heet deze zone?',
    labelPlaceholder: 'bijvoorbeeld: cup',
    tekenen: 'Sleep een vlak op het veld, of tik ergens voor een zone om aan te passen.',
  },
  tekst: {
    titel: 'Tekst',
    vraag: 'Wat moet er staan?',
    placeholder: 'Kort woordje uitleg',
    bewerken: 'Tekst bewerken',
    grootte: 'Grootte',
    klein: 'Klein',
    middel: 'Middel',
    groot: 'Groot',
    plaatsen: 'Tik op het veld waar de tekst moet komen.',
    bewaren: 'Klaar',
    annuleren: 'Annuleren',
  },
  menu: {
