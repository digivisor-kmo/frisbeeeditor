  ...
  zone: {
    volledig: {
      aanval: [
        ...
        { role: 'handler', vanGoalLine: 56, y: MIDDEN + 7 },
        // The poppers stand behind the cup, not in it: ten metres from the disc
        // is where the hole is.
        { role: 'popper', vanGoalLine: 42, y: MIDDEN - 5 },
        { role: 'popper', vanGoalLine: 42, y: MIDDEN + 5 },
        { role: 'wing', vanGoalLine: 36, y: MIDDEN - 14 },
        { role: 'wing', vanGoalLine: 36, y: MIDDEN + 14 },
      ],
      verdediging: [
        { role: 'mark', vanGoalLine: 50, y: MIDDEN },
        { role: 'cup', vanGoalLine: 47.5, y: MIDDEN - 5.5 },
        { role: 'cup', vanGoalLine: 47.5, y: MIDDEN + 5.5 },
        { role: 'mid', vanGoalLine: 40, y: MIDDEN - 12 },
        { role: 'mid', vanGoalLine: 40, y: MIDDEN + 12 },
        { role: 'short-deep', vanGoalLine: 37, y: MIDDEN },
        { role: 'deep-deep', vanGoalLine: 26, y: MIDDEN },
      ],
    },
  },
